...
import { Home, Users, CreditCard, Activity, LogOut, ShieldAlert, Settings, Building2, Megaphone, ShieldCheck, MessageSquare, Flag, UserX } from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { href: '/hq/deletions', label: 'Deletions', icon: UserX },
