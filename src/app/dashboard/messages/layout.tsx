...
export default async function MessagesLayout({ children }: { children: React.ReactNode }) {
  ...
  if (!canUseMessages(getActivePlan(business))) {
    return (
      <PlanLockedScreen
        tier="Business"
        description="Realtime Messaging is an exclusive feature of the Business plan. Upgrade your subscription to communicate with clients and team members in real-time."
      />
    );
  }
