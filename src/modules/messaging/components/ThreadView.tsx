    ...
    <div className="flex flex-col h-full bg-background relative">
      ...
      <div className="flex items-center justify-between px-4 py-2 bg-muted/20 border-b shrink-0">
        ...
        <div className="flex gap-2">
          ...
          <Button variant="ghost" size="sm" onClick={() => refetch()} className="h-6 text-xs px-2" disabled={isFetching}>
            <RefreshCcw className={cn("w-3 h-3 mr-1", isFetching && "animate-spin")} /> Refresh
          </Button>
        </div>
      </div>
